...
function injectStyles(): void {
  ...
  s.textContent = `
    ...
    #ov-group-toggle:hover { background: #2e2e52 !important; color: #fff !important; }
    ...
    .ov-first-party { background: #1a2a3a !important; color: #64b5f6 !important; }
    .ov-third-party { background: #2a1a2e !important; color: #ce93d8 !important; }
    .ov-domain-count {
    ...
    .ov-row.ov-expanded { background: #1a1a40 !important; border-left-color: #5c6bc0 !important; }
    .ov-row-main {
      display: flex !important;
    ...
    .ov-copy-btn:hover { background: #1e1e38 !important; color: #9fa8da !important; }
    .ov-detail {
    ...
    .ov-body-pre::-webkit-scrollbar-thumb { background: #2e2e52 !important; }
    .ov-body-none {
      font-size: 10px !important;
      color: #444 !important;
    ...
    .ov-ws-thread::-webkit-scrollbar-thumb { background: #2e2e52 !important; }
    .ov-ws-msg {
      display: flex !important;
      gap: 6px !important;
